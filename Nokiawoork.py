...
menuOPtion = int(input("Enter a option"))
match (menuOPtionn):
  case 1-> 
  print("phonebook")
 ...
 String phonebook = """
            ...
            case 2 -> {
               ...
               phonebookoption  = int(input("Enter a option"))
                match (phonebookoption):
                    ...
                    case 7 ->{
                       ...
                       set1Choice  = int(input("Enter a option"))
                       match (optionChoice):
                            case 1 -> {
                                    print("Set 1")
            ...
            case 4 -> {
               ...
               print(callRegister);
                 ...
                 callRegisterOption  = int(input("Enter a option"))
                 match (callRegisterOPtion){
                   ...
                   case 5 -> {
                               ...
                               """;    
                              print(showCallDurations)
                               
                                showAllCallDurations = int(input("Enter a option"))
                                match (showAllCallDurations){
                                  ...
                                  case 6 -> {
                                            ...
                                            showAllCallosts = int(input("Enter a option"))
                                  ...
                                  case 7 -> {
                                            ...
                                            listCallCostSettings = int(input("Enter a option"))
                      ...
                      case 6->{
                                ...
                                String settings = """
                                 ...
                                 case 1 -> {
                                          ...
                                          callSettingsChoice = int(input("Enter a option"))
